...
There are core utility packages that have been around a long time such as Biopython. It is the new technique-specific packaeges that aredriving the surging popularity of python i.e scanpY 
...
To get help with a function you can use the question mark beforehand. This will open up the help page for this function. Hopefully this will contain information about what arguments it are accepted and what is returned by the function. In this case we can see there is an additonal optional argument *ndigits*. This has a default value of **None**.
...
```{python}
int_float_string_number = int(string_number)
...
There are many useful functions for working with lists. Many of these functions work directly on the list. This means you use a 
