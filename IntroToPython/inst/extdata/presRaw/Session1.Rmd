...
library(reticulate)
py_suppress_warnings(py_install(c("matplotlib", "numpy", "scipy","seaborn"), pip_options = "--quiet"))
```
...
<img src="iimgs/scanpy_vs_seurat.png" alt="comparison" height="300" width="400">
