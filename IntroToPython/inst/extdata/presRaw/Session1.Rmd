...
Many people prefer to sue an Integrated Development Environment to augment their experience while coding. They allow easy writing of scripts, visualization of plots, and access to many customizable features in additional panes. 
...
Now VS Code is all set up for python we want to mkae sure it using the right python i.e. the python we ave just installed.
...
In this scripting panel we have opened we often will type code, and build scripts. 

---
## Open a python console

As we mentioned before we will be working with our Python interactively. This means we need a Python console to work with.
...
There is is an easier shortcut to do this. Once you start developing code the easiest way to open it is to use the *Tab + Enter* shortcut. 
...
"    
  ...
  cat("# Variables and Functions in Python
