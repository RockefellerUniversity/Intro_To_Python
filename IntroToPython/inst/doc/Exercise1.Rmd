...
```{python, echo=toMessage, fig.keep='none'}
help(pow)
...
- Then try creating 1 variable called "concatenate_1" which stores "I" and another called "concatenate_2" which stores " code" and concatenate both variables. Try, for example, print(concatenate_1 + concatenate_2) - what do you get?
